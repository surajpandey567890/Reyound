   <?php
        ...
        isset($_POST['link']) && $_POST['link']!="" )
    {
        ...
        $final_path = "img/banner/".$image_name[0];

        
     
                $insert=$obj->insert("banner","`image`,`heading`,`sub_heading`,`link`,`createdon`, `status`","'$final_path','$heading','$sub_heading','$link','$today',1");
