	...
	<div class="page-info">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">In Active</li>
			</ol>
		</nav>
	</div>
		...
		<div class="inner-wrapper">
			<div class="row">
				<div class="col">
					<section class="card">
						<div class="card-body">
							<h2 class="card-title">In Active Products</h2>
							<div class="row">
								<div class="col-sm-6">
									<!-- <div class="mb-3">
							...
							<table class="table <?=TABLE_CLASS?>" id="datatable-tabletools">
								...
								<tbody id="tableContainer">
									<?php
									$getProduct = $obj->select("*", "product", "status=0 ORDER BY ID DESC");
