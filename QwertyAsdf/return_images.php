...
<body>
					...
					<div class="col-lg-12">
						<div class="row mb-3">
							...
							if (isset($_GET['return_id']) && $_GET['return_id'] != "") {
								$return_id = base64_decode($_GET['return_id']);

								$get_img_data = $obj->select("ID,image", "return_image", "return_id='$return_id' ORDER BY ID DESC");
	...
	<script src="assets/admin/return_img.js"></script>
