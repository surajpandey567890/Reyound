...
<html class="fixed header-dark">
	...
	<body>
								...
								<table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
									...
									<tbody id="tableContainer">
									    <?php
									        ...
									        $get_data=$obj->select("*","checkout","1 ORDER BY ID DESC");
									        if(is_array($get_data))
									        {
									            foreach($get_data as $key=>$val)
									            {
									                 $product_id=$val[1];
									                 $get_product=$obj->select("*","product","ID='$product_id' ORDER BY ID ASC LIMIT 1");
									   
									                // $order_id=$val[2];
									                // $get_order=$obj->select("*","checkout","ID='$order_id' ORDER BY ID ASC LIMIT 1");
									   ...
									   ?>
            									    <tr>
									                        <td><?=($key+1);?></td>
        										            <td><b><?=$get_product[0][1];?></b> <br><?=$get_product[0][2]?>/<?=$get_product[0][3]?><br> Amount :<?=$get_product[0][5]?><br> </td>
        										            <td><?=$val[2];?></td>
        										            <td><?=$val[3];?></td>
        ...
        <script src="vendor/jquery-validation/jquery.validate.js"></script>
         <script src="assets/admin/checkout.js"></script> 
