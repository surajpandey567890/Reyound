								...
								<div class="card-body">
									<form class="form-horizontal form-bordered" id="addForm" name="addForm" method="post">
									    <div class="form-group row">
											<label class="col-lg-3 control-label text-lg-right pt-2">Type<span style="color:red;">*</span></label>
											<div class="col-lg-6">
											    <select class="form-control populate" name="type_id" id="type_id" data-plugin-selectTwo>
										...
										<div class="form-group row">
											<label class="col-lg-3 control-label text-lg-right pt-2">Category Name<span style="color:red;">*</span></label>
											<div class="col-lg-6">
									...
									<!--<div class="form-group row">
											<label class="col-lg-3 control-label text-lg-right pt-2">English Title <span style="color:red;">*</span></label>
											<div class="col-lg-6">
												<input type="text" class="form-control" name="eng_title" id="eng_title">
											</div>
										</div>-->
										
										<!--<div class="form-group row">-->
										<!--	<label class="col-lg-3 control-label text-lg-right pt-2">Title ( English )<span style="color:red;">*</span></label>-->
										<!--	<div class="col-lg-6">-->
										<!--		<input type="text" class="form-control" name="link" id="link">-->
										<!--		<span style="color:red;">Title must not include any special symbol (@,#,$,%,^,&,*,:,/,+,-,_)</span>-->
										<!--	</div>-->
										<!--</div>-->
								...
								<div class="card-body">
									<form class="form-horizontal form-bordered" id="editForm" name="editForm" method="post">
                                       ...
                                       <div class="form-group row">
											<label class="col-lg-3 control-label text-lg-right pt-2">Type <span style="color:red;">*</span></label>
											<div class="col-lg-6">
											    <select class="form-control populate" name="type_id_edit" id="type_id_edit" data-plugin-selectTwo>
											        <option value="">Select Type</option>
											        <option value="0">Top Product</option>
											        <option value="1">Best Seller</option>
												</select>
