					...
					<header class="page-header">
						...
						<div class="right-wrapper text-right">
							<ol class="breadcrumbs">
								...
								<li><span>Sub Main Category</span></li>
							</ol>
                    ...
                    <div class="row" id="addContainer" style="display:none;">
					    <div class="col">
							<section class="card">
								<header class="card-header">
									<h2 class="card-title">Add Sub Main Category</h2>
								</header>
								<div class="card-body">
					 ...
					 <div class="row" id="editContainer" style="display:none;">
					    <div class="col">
							<section class="card">
								<header class="card-header">
									<h2 class="card-title">Edit Sub Main Category</h2>
								</header>
								<div class="card-body">
									<form class="form-horizontal form-bordered" id="editForm" name="editForm" method="post">
									   ...
									   <div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-lg-6">
											    <select class="form-control" name="sub_cate_id_edit" id="sub_cate_id_edit">
					...
					<div class="col">
                        <section class="card">
							<header class="card-header mt-3">
								<h2 class="card-title">Sub Main Category</h2>
							</header>
							<div class="card-body">
							    <div class="row">
									<div class="col-sm-6">
