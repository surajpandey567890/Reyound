            ...
            success: function (obj) {
                ...
                if (result.response == 'y') {
                    ...
                    $("#cat_id").val(result.cat_id);
                     $("#cate_name_edit").val(result.name);
                    $("#type_id_edit").html(result.option_html);
                }
                else {
                    swal({
                        title: "Oh No!",
