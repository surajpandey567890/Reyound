...
$(document).ready(function () {
    ...
    $("form#addForm").submit(function (e) {
        ...
        //alert("working");
        $.ajax({
            url: 'actions/sub_main_category/add',
            type: 'POST',
            data: formData,
    ...
    $("form#editForm").submit(function (e) {
        ...
        //alert("working");
        $.ajax({
            url: 'actions/sub_main_category/edit',
            type: 'POST',
            data: formData,
            success: function (data) {
                debugger;
    ...
    $("#datatable-tabletools").on("click", ".edit-element", function () {
        ...
        $.ajax({
            type: "POST",
            url: "actions/sub_main_category/get",
            data: { 'ID': ID },
            //timeout: 3000,
            success: function (obj) {
                ...
                if (result.response == 'y') {
                    ...
                    $("#sub_cate_id_edit").html('');
                    $("#sub_cate_id_edit").html(result.sub_html);
                }
                else {
    ...
    $("#datatable-tabletools").on("click", ".update-element", function () {
        ...
        $.ajax({
            type: "POST",
            url: "actions/sub_main_category/status",
            data: { 'ID': ID },
            //timeout: 3000,
           success: function (obj) {
                debugger;
    ...
    $("#datatable-tabletools").on("click", ".remove-element", function () {
        ...
        if (confirm("Are You Sure ?")) {
            ...
            $.ajax({
                type: "POST",
                url: "actions/sub_main_category/delete",
                data: { 'ID': ID },
                //timeout: 3000,
                success: function (obj) {
                    debugger;
