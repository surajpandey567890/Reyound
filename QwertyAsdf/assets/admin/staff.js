        ...
        $.ajax({
            ...
            success: function (obj) {
                ...
                if (result.response == 'y') {
                    ...
                    $("#mobileno_edit").val(result.mobileno);
                    $("#address_edit").val(result.address);
                    $("#work_as_edit").val(result.work_as);
                    $("#salary_edit").val(result.salary);
                }
                else {
                    swal({
                        title: "Oh No!",
